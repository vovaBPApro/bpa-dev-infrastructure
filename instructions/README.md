...
- [autonomy-and-capacity.md](autonomy-and-capacity.md) — Execute approved reviewed dev-only work immediately; run the fleet to its capped width; bound repair to what blocks the product; ask only for the irreversible set.
...
- [orchestrator-fallback.md](orchestrator-fallback.md) — Harness-independent startup and vendor-switchover rules for an orchestrator session.
